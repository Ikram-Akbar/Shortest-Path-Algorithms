...
const GraphVisualizer = () => {
    ...
    const handleFindShortestPath = () => {
        ...
        const newGraph = initializeGraph(); // Get the graph from the current connections
        const { dist, next } = floydWarshall(newGraph, n); // Use the new graph for calculation
        if (next[u1][u2] === -1) return null;
            ...
            <Row>
                <Col>
                    ...
                    <Row className="mb-3">
                        ...
                        <Col>
                            <Button variant="secondary" onClick={() => setGraph(initializeGraph())}>Initialize Graph</Button>
                        </Col>
                    </Row>
